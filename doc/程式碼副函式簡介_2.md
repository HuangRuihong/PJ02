...
### 函式: generate_qr_path (Line 30 - 43)
**簡介**：產生 QR Code 圖片並傳回暫存路徑
...
### 函式: trigger_scan (Line 109 - 112)
**簡介**：觸發主程式的 QR Code 掃描功能
