...
class FriendsFrame(ctk.CTkFrame):
    ...
    def setup_ui(self):
        ...
        ctk.CTkButton(self.header, text="+ 掃描好友名片", width=120, command=self.master.master.scan_qr_from_file).pack(side="right", padx=10)
    ...
    def refresh(self):
        ...
        for fid in friends:
            ...
            ctk.CTkButton(f, text="發起記帳", width=80, command=lambda u=fid: self.master.master.quick_charge(u)).pack(side="right", padx=10)
